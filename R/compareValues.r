# Helper function to aid comparison of values reported in articles to values obtained in reproducibility checks.
...
# Function returns a short text report noting the error type and the PE. 
