...
# reportObject$errorLocus_typo <- 1 or 0
# reportObject$errorLocus_specification <- 1 or 0
# reportObject$errorLocus_analysis <- 1 or 0
# reportObject$errorLocus_data <- 1 or 0
# reportObject$errorLocus_unidentified <- 1 or 0
# reportObject$Author_Assistance <- T or F
# reportObject$assistanceTypo <- 0
# reportObject$assistanceData <- 0
# reportObject$assistanceSpecification <- 0
